...
class MainWindow(QMainWindow):
    ...
    def open_transcription_viewer(self, transcription: Transcription):
        ...
        # Connect the rerun_triggered signal to on_file_transcriber_triggered
        self.transcription_viewer_widget.rerun_triggered.connect(self.on_file_transcriber_triggered)
