...
from buzz.assets import get_models_path
...
model_root_dir = get_models_path()
...
class TranscriptionModel:
    ...
    def __str__(self):
        match self.model_type:
            ...
            # OLLAMA_WHISPER_API has been removed
            #    return "Ollama Whisper API"
            case _:
...
# def get_ollama_model(settings):
#     """Get the Ollama model name from settings"""
#     from buzz.settings.settings import Settings
    
#     model_name = settings.value(
#         key=Settings.Key.OLLAMA_MODEL, 
#         default_value="ZimaBlueAI/whisper-large-v3:latest"
#     )
#     return model_name
